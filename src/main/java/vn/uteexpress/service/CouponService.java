...
public class CouponService {
    ...
    public Coupon createCoupon(Coupon coupon, Long shopId) {
        ...
        if (coupon.getStartAt() == null ||
            ...
            throw new RuntimeException(
                    "Phải nhập thời gian bắt đầu và kết thúc");
        }
        ...
        if (coupon.getType() == CouponType.PERCENT &&
                coupon.getDiscountValue().compareTo(
    ...
    public Coupon updateCoupon(Long couponId,
        ...
        if (shopId != null) {
            ...
            if (coupon.getShop() == null ||
                    !coupon.getShop().getId().equals(shopId)) {

                throw new RuntimeException(
                        "Coupon không thuộc Shop này");
            }
        }
    ...
    public List<Coupon> getCouponsByShop(Long shopId) {
        ...
        return couponRepository
                .findByShopIdOrderByStartAtDesc(shopId);
    }

    public List<Coupon> getActiveCoupons() {

        return couponRepository
                .findByActiveTrueOrderByStartAtDesc();
    }
    ...
    public void validateCoupon(
        ...
        if (coupon.getStartAt() == null ||
            ...
            throw new RuntimeException(
                    "Coupon chưa được cấu hình thời gian");
        }
        ...
        if (orderAmount == null ||
            ...
            throw new RuntimeException(
                    "Đơn hàng chưa đạt giá trị tối thiểu để sử dụng coupon");
        }
    }
    ...
    private void validateCouponData(Coupon coupon) {
        ...
        if (coupon.getStartAt() == null ||
            ...
            throw new RuntimeException(
                    "Thời gian coupon không được để trống");
        }

        if (!coupon.getEndAt()
                .isAfter(coupon.getStartAt())) {
